...
from __init__ import pomodoro_timer
...
work_label = "Nice long work label s.03-194573 || 2 || Nice long work label s.03-194573"  # Label for work session
break_label = "Break"  # Label for break session
text_color = "skyblue"  # Text color
size = 300  # Size of the timer
stroke_width_input = 1  # Stroke width for the timer
